...
//		ArrayList<T> curList = new ArrayList<T>(array.length);
//		new Random().ints(0, array.length).distinct().limit(array.length).forEach(x -> curList.add(array[x]));
//		return curList.toArray(Arrays.copyOf(array, array.length));
//		
//	}
	default T[] toShuffleArray(T[] array) {
